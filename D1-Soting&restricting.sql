...
select first_name,salary from employees  --- select colname

select employee_id , salary , salary *1.10 ---select expression 
from employees

====================================
--whose salary greater than 17k
select * from employees
where salary>17000
=========================================
--whose salary greater than or equal 17k
select * from employees
where salary>=17000


=============================================
--whose salary between  17k & 24k
select * from employees 
where salary >= 17000 and salary <= 24000

select * from employees 
where salary between 17000 and 24000
=======================================
--whose hire date after 1989 year 
select * from employees
...
================================
--whose salary is greater than 6k AND
--his department is 6
select * from employees 
where salary>6000 and department_id =6
==================================================
...
--employees is department number 6 , 7 ,8
select * from employees 

where department_id = 6 or department_id = 7 or department_id = 8


select * from employees 

where department_id in (6,7,8)


select * from employees 

where department_id  between 6 and 8

===================================================
--whose last name contains a and e at the same time     eg: harven 
select * from employees 
...
select * from employees  --using column   in ascending order 
order by salary 
--

select * from employees  --using column   in descending order 
...
select first_name ,lasT_name ,salary from employees -- using column postion
order by 3  desc



select first_name ,lasT_name ,salary as sal from employees  --using alias
order by sal desc
